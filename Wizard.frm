...
Begin VB.Form frmWizard 
   ...
   Begin VB.Frame fraStep 
      ...
      Begin VB.CheckBox chkShowIntro 
         ...
         Width           =   3810
      End
      Begin VB.Label lblExtraInfo5 
         Caption         =   "Policy - Where the PC downloads it's policy from."
         Height          =   255
         Left            =   3000
         TabIndex        =   24
         Top             =   1920
         Width           =   3975
      End
      Begin VB.Label lblExtraInfo4 
         Caption         =   "Siteserver - The server at the same location as this PC."
         Height          =   255
         Left            =   3000
         TabIndex        =   23
         Top             =   1680
         Width           =   3975
      End
      Begin VB.Label lblExtraInfo3 
         Caption         =   "Prtloc - The default printer to use."
         Height          =   255
         Left            =   3000
         TabIndex        =   22
         Top             =   1440
         Width           =   3375
      End
      Begin VB.Label lblExtraInfo2 
         Caption         =   "Siteloc - The physical location of the PC."
         Height          =   255
         Left            =   3000
         TabIndex        =   21
         Top             =   1200
         Width           =   3375
      End
      Begin VB.Label lblExtraInfo1 
         Caption         =   "Settings that may be changed are:"
         Height          =   255
         Left            =   2760
         TabIndex        =   20
         Top             =   840
